;(function ($, window, document, undefined) {
  ...
  Foundation.libs.topbar = {
    ...
    if (sticky && settings.sticky_on === 'all' || sticky && settings.sticky_on === 'small-up') {
        return true;
        ...
        return (matchMedia(Foundation.media_queries.small).matches && matchMedia(Foundation.media_queries.medium).matches &&
                matchMedia(Foundation.media_queries.large).matches);
        //return true;
    } else if(sticky && settings.sticky_on === 'medium-up') {
        if(this.medium() || this.large()) {
            return (matchMedia(Foundation.media_queries.small).matches && matchMedia(Foundation.media_queries.medium).matches &&
                    matchMedia(Foundation.media_queries.large).matches);
        }
    } else if(sticky && settings.sticky_on === 'large-up' && this.large()) {
            return (matchMedia(Foundation.media_queries.small).matches && matchMedia(Foundation.media_queries.medium).matches &&
                    matchMedia(Foundation.media_queries.large).matches);
    }
    return false;
